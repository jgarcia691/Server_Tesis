...
export const getsedecontroller = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error al obtener las sedes", error: error.message });
  }
};
...
export const getsedebyidcontroller = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error al obtener la sede", error: error.message });
  }
};
...
export const postsedecontroller = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error al crear la sede", error: error.message });
  }
};
...
export const deletesedecontroller = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error al eliminar la sede", error: error.message });
  }
};
